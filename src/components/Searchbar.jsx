...
const Searchbar = () => {
    ...
    const fetchSuggestions = async (searchTerm) => {
        try {
            setLoading(true);
            const response = await axios.get(`${import.meta.env['VITE_BACKEND-URL']}/api/stocks/search`, {
                params: {
                    query: searchTerm,
                },
            });
    ...
    const fetchStockData = async (stockTicker, interval) => {
        ...
        try {
            const response = await axios.get(`${import.meta.env['VITE_BACKEND-URL']}/api/stocks/get_data`, {
                params: {
                    stock: stockTicker,
